...
import { DEFAULT_LOCALE, getLocalePlugin, getSupportedLocales } from "@/lib/i18n/registry";
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  // Read the registry at translation time so newly registered messages are
  // visible during development hot reload without remounting the provider.
  const t = useCallback((key: string, params?: TranslationParams) => translateMessage(locale, key, getMessages(), params), [locale]);
