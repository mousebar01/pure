...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.general": "通用",
    "common.archived": "已归档",
    "common.hiddenWorkspaces": "已隐藏工作区",
    "common.theme": "主题",
    "common.mobileDevices": "移动设备",
    "settings.needProject": "请先打开一个项目，再管理技能和插件。",
    "settings.archivedDescription": "恢复已归档的对话，或将它们从本机永久删除。",
    "settings.archivedLoading": "正在加载已归档对话…",
    "settings.archivedEmpty": "暂无已归档对话",
    "settings.archivedCount": "{count} 个已归档对话",
    "settings.archivedUnknownDate": "归档时间未知",
    "settings.archivedBranch": "分支",
    "settings.restoreArchived": "恢复",
    "settings.permanentDelete": "永久删除",
    "settings.permanentDeletePrompt": "此操作无法撤销。",
    "settings.hiddenWorkspacesDescription": "恢复从侧栏隐藏的工作区。工作区中的文件和对话都会保留。",
    "settings.hiddenWorkspacesLoading": "正在加载已隐藏工作区…",
    "settings.hiddenWorkspacesEmpty": "暂无已隐藏工作区",
    "settings.hiddenWorkspacesCount": "{count} 个已隐藏工作区",
    "settings.hiddenWorkspacesUnknownDate": "隐藏时间未知",
    "settings.restoreWorkspace": "恢复工作区",
    "settings.restoringWorkspace": "恢复中…",
    "common.help": "帮助",
    "help.inputTitle": "输入技巧",
    "help.commandsTitle": "使用命令",
    "help.commandsDescription": "输入 / 浏览并选择可用命令。",
    "help.filesTitle": "引用文件",
    "help.filesDescription": "输入 @ 搜索并将项目文件加入消息。",
    "welcome.greeting": "今天想要做什么？",
    "sidebar.hide": "隐藏侧边栏",
    "sidebar.show": "显示侧边栏",
    "theme.light": "切换到浅色模式",
    "theme.dark": "切换到深色模式",
    ...
    "sidebar.new": "新对话",
    "sidebar.newSessionTitle": "在 {path} 中开始新对话",
    "sidebar.refresh": "刷新",
    ...
    "sidebar.workspaceOptions": "工作区管理",
    "sidebar.workspaceOpen": "打开对话列表",
    "sidebar.workspaceFiles": "浏览文件",
    "sidebar.workspaceChanges": "查看变更",
    "sidebar.workspaceNewSession": "新建对话",
    "sidebar.workspaceCopyPath": "复制路径",
    "sidebar.workspaceCopied": "路径已复制",
    "sidebar.workspaceHide": "从侧栏隐藏",
    ...
    "sidebar.archiveSession": "归档此对话及其分支",
    "sidebar.archiveRunning": "请等待对话完成后再归档",
    "sidebar.archivedToast": "已归档：{title}",
    "sidebar.undoArchive": "撤销",
    ...
    "files.searchSearching": "搜索中…",
    "files.searchFailed": "搜索失败",
    "files.searchEmpty": "没有匹配的文件",
    "files.clearSearch": "清除搜索",
    "changes.empty": "没有变更",
    "changes.notGitRepository": "不是 Git 仓库",
    "changes.staged": "已暂存",
    "changes.unstaged": "已修改",
    ...
    "chat.runningActions": "正在{actions}...",
    ...
    "chat.scrollToRunning": "查看正在生成的内容",
    "chat.worked": "已完成工作",
    "chat.activity": "项活动",
    "chat.activities": "项活动",
    "chat.action.read": "读取",
    "chat.action.edit": "编辑",
    "chat.action.search": "搜索",
    "chat.action.run": "运行",
    "chat.action.inspect": "查看",
    "chat.action.useTool": "调用工具",
    "chat.message": "条消息",
    "chat.messages": "条消息",
    "chat.toolCall": "次工具调用",
    ...
    "i18n.forkConversation": "另起对话",
    "i18n.forkConversationTitle": "保留此回答并另起对话",
    "i18n.continueInNewChat": "另起对话",
    "i18n.continueInNewChatTitle": "保留此回答，从这里继续新对话",
    "i18n.creatingFork": "正在创建新对话…",
