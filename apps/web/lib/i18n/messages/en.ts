...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.hiddenWorkspaces": "Hidden workspaces",
    "common.theme": "Theme",
    "common.mobileDevices": "Mobile",
    "settings.needProject": "Open a project first to manage skills and plugins.",
    "settings.archivedDescription": "Restore archived conversations or permanently remove them from this device.",
    "settings.archivedLoading": "Loading archived conversations…",
    "settings.archivedEmpty": "No archived conversations",
    "settings.archivedCount": "{count} archived conversations",
    "settings.archivedUnknownDate": "Archived date unavailable",
    "settings.archivedBranch": "fork",
    "settings.restoreArchived": "Restore",
    "settings.permanentDelete": "Delete permanently",
    "settings.permanentDeletePrompt": "This cannot be undone.",
    "settings.hiddenWorkspacesDescription": "Restore workspaces hidden from the sidebar. Their files and conversations are kept intact.",
    "settings.hiddenWorkspacesLoading": "Loading hidden workspaces…",
    "settings.hiddenWorkspacesEmpty": "No hidden workspaces",
    "settings.hiddenWorkspacesCount": "{count} hidden workspaces",
    "settings.hiddenWorkspacesUnknownDate": "Hidden date unavailable",
    "settings.restoreWorkspace": "Restore workspace",
    "settings.restoringWorkspace": "Restoring…",
    "common.help": "Help",
    "help.inputTitle": "Input tips",
    "help.commandsTitle": "Use commands",
    "help.commandsDescription": "Type / to browse and select an available command.",
    "help.filesTitle": "Reference files",
    "help.filesDescription": "Type @ to find and add project files to your message.",
    "welcome.greeting": "What would you like to do today?",
    ...
    "sidebar.newSessionTitle": "Start a new chat in {path}",
    ...
    "sidebar.workspaceOptions": "Workspace options",
    "sidebar.workspaceOpen": "Open conversations",
    "sidebar.workspaceFiles": "Browse files",
    "sidebar.workspaceChanges": "View changes",
    "sidebar.workspaceNewSession": "Start new chat",
    "sidebar.workspaceCopyPath": "Copy path",
    "sidebar.workspaceCopied": "Path copied",
    "sidebar.workspaceHide": "Hide from sidebar",
    ...
    "sidebar.archiveSession": "Archive this conversation and its forks",
    "sidebar.archiveRunning": "Finish the running conversation before archiving",
    "sidebar.archivedToast": "Archived {title}",
    "sidebar.undoArchive": "Undo",
    ...
    "sidebar.uncommittedChanges": "Uncommitted changes",
    ...
    "files.searchSearching": "Searching…",
    ...
    "changes.notGitRepository": "Not a Git repository",
    ...
    "chat.scrollToRunning": "View the latest activity",
    "chat.worked": "Worked",
    "chat.activity": "activity",
    "chat.activities": "activities",
    "chat.action.read": "Read",
    "chat.action.edit": "Edit",
    "chat.action.search": "Search",
    "chat.action.run": "Run",
    "chat.action.inspect": "Inspect",
    "chat.action.useTool": "Use tool",
    ...
    "chat.messagePlaceholder": "Type anything…",
    "chat.steer": "Steer",
    ...
    "i18n.loadingThinkingShort": "Restoring thought summary...",
    "i18n.thought": "Thought",
    ...
    "i18n.forkConversation": "New chat from here",
    "i18n.forkConversationTitle": "Keep this answer and continue in a new chat",
    "i18n.continueInNewChat": "New chat from here",
    "i18n.continueInNewChatTitle": "Keep this answer and continue in a new chat",
    "i18n.creatingFork": "Creating new chat…",
